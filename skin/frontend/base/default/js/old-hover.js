...
//		$("#floatmenu01").show();	
	...
	function(){
		...
		setTimeout(function()
		{
			//var divThis = $(menuValue);
			
			if (ooldMenuValue == newMenuValue)
			{
//				alert(ooldMenuValue);
//				alert(divThis.hasClass("hover"));
				divThis = $("#sub_floor_menus");
...
/*		$("#sub_floor_menus").hover(
	...
	$("#sub_floor_menus").hover(function(){
		$("this").show();
//		$("this").addClass("hover");
		$(newMenuValue).show();
		//$(menuValue).addClass("hover");
		$("#sub_floor_menus").addClass("hover");
		//$("#floatmenu01").show();
	},
	function(){
		//$(menuValue).removeClass("hover");
		$(newMenuValue).hide();
		$("#sub_floor_menus").removeClass("hover");
		//$("#floatmenu01").hide();
		$("this").hide();	
	});	
