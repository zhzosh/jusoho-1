...
//            }
    ...
    protected function _initProductSave()
    {
        ...
        if($data=$this->getRequest()->getPost('color_text')){   
            $product->setConfigurableAttributesColorTextData($data);
        }
        
        if($data=$this->getRequest()->getPost('color_pic_check')){   
            $product->setConfigurableAttributesColorPicCheckData($data);
        }
    ...
    public function quickCreateAction()
    {
        ...
        foreach ($configurableProduct->getTypeInstance()->getConfigurableAttributes() as $attribute) {
            ...
            if($attribute->getProductAttribute()->getFrontendInput()=='color'){
                $attribute->getProductAttribute()->getSource()->saveData( $product->getData($attribute->getProductAttribute()->getAttributeCode()),$configurableProduct->getId());
            }
        }
