...
class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
{
    ...
    public function preDispatch()
    {
        ...
        if (!preg_match('/^(create|login|checkEmail|checkUsername|checkUserphone|logoutSuccess|forgotpassword|forgotpasswordpost|confirm|confirmation)/i', $action)) {
