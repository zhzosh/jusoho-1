...
class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
{
    ...
    {
        $allowLoginTypes = Mage::getStoreConfig('customer/startup/allow_login_type');
        $allowLoginType = explode(',', $allowLoginTypes);
        $types = array('email' => 'loadByEmail', 'username' => 'loadByUsername', 'phone' => 'loadByPhone');
    ...
    /**
     * Load customer by userphone
     *
     * @param   string $customerUserphone
     * @return  Mage_Customer_Model_Customer
     */
    public function loadByPhone($customerPhone)
    {
        $collection=$this->getResourceCollection();
        $collection->addFieldToFilter('phone', $customerPhone);
        $item=$collection->load()->getFirstItem();
