...
class Mage_Customer_Block_Form_Register extends Mage_Directory_Block_Data
{
    ...
    public function allowShowUsername()
    {
    	$attributes=Mage::getStoreConfig('customer/create_account/register_required_login_attributes');
    ...
    public function allowShowPhone()
    {
     	$attributes=Mage::getStoreConfig('customer/create_account/register_required_login_attributes');
     	$attribute=explode(',',$attributes);
