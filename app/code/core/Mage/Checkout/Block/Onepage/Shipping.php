...
class Mage_Checkout_Block_Onepage_Shipping extends Mage_Checkout_Block_Onepage_Abstract
{
    ...
    {
    	static $_defaultAddress = null;
    	if (is_null($_defaultAddress)) {
    		$_defaultAddress = $this->getCustomer()->getDefaultShippingAddress();
    	}
    ...
    {
    	if (($address = $this->getCustomerDefaultAddress()) && ($id = $address->getId())) {
    		return $id;
    	}
    	return null;
    }
